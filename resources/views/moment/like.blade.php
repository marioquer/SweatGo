...
@section('info-nav')
    <ul class="left-list">
        ...
        <li class="active"><a href="like" class="waves-effect waves-teal teal-text text-darken-4 center">收到的赞</a></li>
    </ul>
@stop

@section('middle-block')
    <div class="card white">
        <div class="card-content margin-left-10 min-height-500"> <span class="card-title teal-text text-darken-4">收到的赞</span>
