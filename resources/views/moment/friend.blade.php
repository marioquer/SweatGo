...
@section('info-nav')
    <ul class="left-list">
        ...
        <li class="active"><a href="friend" class="waves-effect waves-teal teal-text text-darken-4 center">我的好友</a></li>
...
@section('middle-block')
    <div class="card white">
        <div class="card-content margin-left-10 min-height-500"> <span class="card-title teal-text text-darken-4">我的好友</span>
