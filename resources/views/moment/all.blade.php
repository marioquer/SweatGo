...
@section('info-nav')
    <ul class="left-list">
        <li class="active"><a href="all" class="waves-effect waves-teal teal-text text-darken-4 center">全部动态</a></li>
...
@section('middle-block')
    <div class="card white">
        <div id="momentList" class="card-content margin-left-10 "><span class="card-title teal-text text-darken-4">全部动态</span>
            <div onclick="window.location.href='all'" class="refreshButton grey-text text-darken-3 material-icons right margin-top-5">autorenew</div>
